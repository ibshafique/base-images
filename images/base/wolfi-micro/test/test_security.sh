#!/bin/bash
# Description: Security tests for wolfi-micro base image
...
test_image_is_minimal() {
    assert_image_size_under 30 "wolfi-micro should be under 30MB"
}
...
test_title_label() {
    assert_label_value "org.opencontainers.image.title" "wolfi-micro"
}
