#!/usr/bin/env bash
# scratch-plus Build Script
# Minimal scratch image with CA certificates and non-root user
#
# Parameters:
...
#   ./build.sh clean build test --load --debug
...
readonly IMAGE_NAME="scratch-plus"
...
target_info() {
    ...
    log_info "Git SHA: $(get_scoped_git_sha_short "${MODULE_DIR}")"
}
