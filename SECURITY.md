...
```json
{
  ...
  "invocation": {
    ...
    "parameters": {
      ...
      "context": "./images/base/scratch-plus"
    }
  },
  "materials": [
    {
      "uri": "docker.io/library/alpine:3.19",
...
Note: This is a simplified representation. The actual attestation generated by BuildKit includes full build metadata.
...
**Future Work**: Upgrade to L3 by adopting slsa-github-generator.
...
| **Pinned dependencies** | Digest-pinned base images (scratch-plus) | Dockerfile FROM directives |
